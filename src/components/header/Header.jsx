    ...
    <nav className="yta_Header-menu">
      ...
      <ul className="yta_Header-menu-list">
        <li className="yta_Header-menu-list-item">
          <a href="#adoptar" className="yta_Link-underline--primary">
            Adoptar
          </a>
        </li>
        <li className="yta_Header-menu-list-item">
          <a id="addPet" href="#adopcion" className="yta_Link-underline--primary">
            Dar en adopción
          </a>
        </li>
        <li className="yta_Header-menu-list-item">
          <a href="#login" className="yta_Link-underline--primary">
            Iniciar sesión
          </a>
        </li>
      </ul>
